      ...
      >
        {hasChildren ? (
          <button
            ...
            // A plain 10px gray arrow read as decoration, not a control — this
            // gives it a visible button shape (border + background) so it's
            // obviously clickable, with a stronger hover/rotate cue.
            className="flex shrink-0 items-center justify-center rounded-md border text-[11px] transition-all hover:border-neutral-500 hover:bg-white/10"
            style={{
              width: 20,
              height: 20,
              borderColor: "#3a3a3a",
