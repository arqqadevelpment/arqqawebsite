...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    body: "Reels & short-form content. Brand films & commercials. Product & testimonial videos. Motion graphics & animation. Content creator direction. The feed belongs to video, and your brand belongs in it.",
