...
import { ARTICLES, categorySlug } from "../components/insights/insights-data.ts";
...
const STATIC_PAGES: PageRow[] = [
  ...
  { path: "/services/performance-marketing-app-growth", parent_path: "/services", title: "Performance Marketing", page_type: "static" },
];
...
const rows: PageRow[] = [
  ...
  ...ARTICLES.map((a) => ({
    path: `/insights/${categorySlug(a.category)}/${a.slug}`,
