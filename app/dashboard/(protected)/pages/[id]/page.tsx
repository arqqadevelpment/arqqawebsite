...
import { buildCanonicalUrl } from "@/lib/content/seo";
...
export default async function PageDetail({
  ...
  const { data: seo } = await supabase
    .from("seo_meta")
    .select(
      "seo_title, meta_description, keywords, canonical_url, og_title, og_description, og_image, twitter_card, robots_directive, article_author, article_published_at",
    )
    ...
    <div>
      ...
      <div style={{ display: "flex", gap: 24, flexWrap: "wrap", alignItems: "flex-start" }}>
        ...
        >
          ...
          <SeoForm
            pagePath={page.path}
            defaultCanonical={buildCanonicalUrl(siteUrl, page.custom_path || page.path)}
