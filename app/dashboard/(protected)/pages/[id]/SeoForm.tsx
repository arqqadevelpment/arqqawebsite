...
export function SeoForm({
  ...
  pagePath: string;
  /** The URL this page canonicalises to when the override is left blank. */
    ...
    >
      ...
      <Field label="Keywords">
        <input
          ...
          style={inputStyle}
          placeholder="Comma-separated, e.g. branding agency egypt, brand strategy"
        />
      </Field>
      ...
      <Field label="Canonical URL override">
        ...
        />
        <span style={{ color: "#737373", fontSize: 11, marginTop: 4, display: "block" }}>
          Leave blank to canonicalise to {defaultCanonical} — it follows this page&apos;s URL automatically.
        </span>
      </Field>
